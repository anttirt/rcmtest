...
namespace Unity.Entities
{
    static partial class MemoryProfiler
    {
        ...
        static UnsafeList<WorldAllocatorData> s_WorldAllocatorData;
        ...
        public static void Initialize()
        {
            ...
            s_WorldAllocatorData = new UnsafeList<WorldAllocatorData>(8, Allocator.Persistent);
            s_Initialized = true;
        }
        ...
        internal static unsafe void Internal_UpdateWorld(World world)
        {
            ...
            var eqm = access->EntityQueryManager;
            s_WorldAllocatorData.Clear();
            s_WorldAllocatorData.Add(new WorldAllocatorData(
                world.SequenceNumber,
                ecs->ArchetypeChunkAllocatorUsedBytes,
                ecs->ArchetypeChunkAllocatorBudgetBytes,
                eqm->EntityQueryDataAllocatorUsedBytes,
                eqm->EntityQueryDataAllocatorBudgetBytes));
            Profiler.EmitFrameMetaData(Guid, 1, s_WorldAllocatorData.AsNativeArray());
        }
