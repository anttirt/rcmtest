...
partial struct MyJob : global::Unity.Entities.IJobChunk
{
    ...
    {
        var entityPointer = Unity.Entities.Internal.InternalCompilerInterface.UnsafeGetChunkEntityArrayIntPtr(chunk, __TypeHandle.__Unity_Entities_Entity_TypeHandle);
        ...
        if (!useEnabledMask)
        {
            ...
            {
                var entity = Unity.Entities.Internal.InternalCompilerInterface.UnsafeGetCopyOfNativeArrayPtrElement<Entity>(entityPointer, entityIndexInChunk);
                Execute(entity);
                matchingEntityCount++;
            }
        }
    ...
    public struct InternalCompilerQueryAndHandleData
    {
        ...
        void __AssignQueries(ref global::Unity.Entities.SystemState state)
        {
            ...
            DefaultQuery = 
                entityQueryBuilder
                    .WithDisabled<global::Unity.Entities.Tests.EcsTestDataEnableable>()
                    .Build(ref state);
            entityQueryBuilder.Reset();
            DefaultQuery.SetChangedVersionFilter(new ComponentType[1]
            {
                new ComponentType(typeof(global::Unity.Entities.Tests.EcsTestDataEnableable))
            });
