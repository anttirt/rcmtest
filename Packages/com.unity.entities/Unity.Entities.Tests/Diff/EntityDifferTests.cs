...
namespace Unity.Entities.Tests
{
    ...
    sealed class EntityDifferTests : EntityDifferTestFixture
    {
        ...
        [UnityPlatform(exclude = new RuntimePlatform[] {
            RuntimePlatform.LinuxEditor, // Disabled for Instability https://jira.unity3d.com/browse/UUM-146522
            RuntimePlatform.WindowsEditor // Disabled for Instability https://jira.unity3d.com/browse/UUM-146522
        })]
