...
namespace Unity.Entities.PerformanceTests
{
    ...
    public partial class EntityQueryIncrementalCachingPerformanceTests : EntityPerformanceTestFixture
    {
        ...
        {
            // UUM-146457 - Disabling the tests that timeout consistently on daily trigger
            if (UnityEngine.Application.platform == UnityEngine.RuntimePlatform.PS4 ||
                UnityEngine.Application.platform == UnityEngine.RuntimePlatform.PS5 ||
                UnityEngine.Application.platform == UnityEngine.RuntimePlatform.Switch)
                Assert.Ignore("[UUM-146457] Skipped: Timing out on PS4,PS5,Switch");
