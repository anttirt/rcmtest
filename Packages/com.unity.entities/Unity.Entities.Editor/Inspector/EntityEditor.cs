...
namespace Unity.Entities.Editor
{
    ...
    class EntityEditor : UnityEditor.Editor, IBinding
    {
        ...
        bool HasFrameBounds()
        {
            return m_InspectorContext.TryGetComponentData<LocalToWorld>(out _);
        }

        Bounds OnGetFrameBounds()
        {
            m_InspectorContext.TryGetComponentData<LocalToWorld>(out var ltw);
            return new Bounds((Vector3)ltw.Position, Vector3.one);
        }
