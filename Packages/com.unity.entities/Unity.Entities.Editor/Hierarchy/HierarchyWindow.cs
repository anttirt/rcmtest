...
namespace Unity.Entities.Editor
{
    partial class HierarchyWindow : DOTSEditorWindow
    {
        ...
        VisualElement CreateToolbar(VisualElement root, Hierarchy hierarchy)
        {
            ...
            deprecationWarning.text = "The Entities Hierarchy window is deprecated and will be removed in a future version. Entities have now been integrated into the new Hierarchy window. Enable the new Hierarchy in Preferences/General/Use new Hierarchy window";
            deprecationWarning.SetVisibility(true);

            var openPreferencesButton = new Button(() => SettingsService.OpenUserPreferences("Preferences/_General"))
            {
            ...
            deprecationWarning.Add(openPreferencesButton);
